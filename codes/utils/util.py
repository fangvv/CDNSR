...
def cal_FLOPs(which_model,num_ress):
    if which_model =='classSR_3class_fsrcnn_net':
        ...
        percent = flops / 32.60
    elif which_model=='ee_classSR_3class_carn':
        flops = (0.65 * num_ress[0] + 0.9 * num_ress[1] + 1.15 * num_ress[2]) / sum(num_ress)
        percent = flops / 1.15
