...
LR_folder="/path/to/you/project/datasets/DIV2K_scale_sub/LR"
GT_folder="/path/to/you/project/datasets/DIV2K_scale_sub/GT"

save_list=["/path/to/you/project/datasets/DIV2K_scale_sub_psnr_LR_class3",
           "/path/to/you/project/datasets/DIV2K_scale_sub_psnr_LR_class2",
           "/path/to/you/project/datasets/DIV2K_scale_sub_psnr_LR_class1",
           "/path/to/you/project/datasets/DIV2K_scale_sub_psnr_GT_class3",
           "/path/to/you/project/datasets/DIV2K_scale_sub_psnr_GT_class2",
           "/path/to/you/project/datasets/DIV2K_scale_sub_psnr_GT_class1"]
for i in save_list:
    if os.path.exists(i):
        pass
    else:
...
f1 = open("/path/to/you/project/codes/data_scripts/divide_train.log")
a1 = f1.readlines()
index=0
for i in a1:
    index+=1
