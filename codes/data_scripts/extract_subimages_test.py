...
def check_path(path):
    index = path.rfind('/') + 1
    if path[index: index + 4] == '0800':
        return False
    elif path[index: index + 2] == '08' or path[index: index + 2] == '09':
        return True
    else:
        return False
...
def main():
    ...
    if mode == 'pair':
        ...
        GT_folder = '/path/to/you/project/dataset/DIV2K/DIV2K_train_HR'  # fix to your path
        LR_folder = '/path/to/you/project/dataset/DIV2K/DIV2K_train_LR_bicubic/X4'  # fix to your path
        save_GT_folder = '/path/to/you/project/datasets/DIV2K_valid_HR_sub/GT'
        save_LR_folder = '/path/to/you/project/datasets/DIV2K_valid_HR_sub/LR'
