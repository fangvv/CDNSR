...
def main():
    ...
    if mode == 'pair':
        # cut training data
        GT_folder = '/path/to/you/project/datasets/DIV2K800_scale/HR/x4'# fix to your path
        LR_folder = '/path/to/you/project/datasets/DIV2K800_scale/LR/x4'# fix to your path
        save_GT_folder = '/path/to/you/project/datasets/DIV2K_scale_sub/GT'
        save_LR_folder = '/path/to/you/project/datasets/DIV2K_scale_sub/LR'
